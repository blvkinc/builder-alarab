...
import { ArrowRight, CheckCircle, Users, Award, TrendingUp, Menu, X, Building, Briefcase, GraduationCap, Lightbulb } from "lucide-react";
...
export default function Variation4() {
  ...
  const achievements = [
    { number: "15,000+", label: "Companies Established", icon: <Building className="w-6 h-6" /> },
    { number: "99.2%", label: "Success Rate", icon: <Award className="w-6 h-6" /> },
    { number: "50+", label: "Expert Consultants", icon: <Users className="w-6 h-6" /> },
    { number: "24/7", label: "Premium Support", icon: <TrendingUp className="w-6 h-6" /> },
  ];
  ...
  const services = [
    {
      ...
      description: "Complete business registration and licensing across all UAE jurisdictions including mainland and free zones.",
      features: ["Trade License", "Memorandum of Association", "Share Certificates", "Company Seal"]
    },
    {
      icon: <Briefcase className="w-12 h-12" />,
      title: "Corporate Banking",
      description: "Establish banking relationships with top-tier financial institutions for seamless business operations.",
      features: ["Account Opening", "Multi-currency Support", "Online Banking", "Credit Facilities"]
    },
    {
      icon: <GraduationCap className="w-12 h-12" />,
      title: "Visa Services",
      description: "Comprehensive visa processing for business owners, employees, and family members.",
      features: ["Investor Visa", "Employment Visa", "Family Visa", "Golden Visa"]
    },
    {
      icon: <Lightbulb className="w-12 h-12" />,
      title: "Business Advisory",
      description: "Strategic consulting and ongoing compliance support to ensure long-term business success.",
      features: ["Tax Planning", "Legal Compliance", "Audit Support", "Business Growth"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "The professionalism and expertise demonstrated throughout our company setup was exceptional. We were operational within 8 days.",
      image: "👨‍💼"
    },
    {
      name: "Dr. Fatima Al-Zahra",
      title: "Founder, MedConsult FZ",
      content: "Outstanding service quality and attention to detail. The team handled every aspect of our healthcare business licensing seamlessly.",
      image: "👩‍⚕️"
    },
    {
      name: "James Chen",
      title: "Director, Global Trade LLC",
      content: "Their deep understanding of UAE business regulations and proactive approach made our expansion into MENA markets effortless.",
      image: "👨‍💻"
    }
  ];
    ...
    <div className="min-h-screen bg-neutral-900 text-white">
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <div className={"bg-[url('data:image/svg+xml,%3Csvg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" fill-rule=\"evenodd\"%3E%3Cg fill=\"%23ffffff\" fill-opacity=\"1\"%3E%3Ccircle cx=\"30\" cy=\"30\" r=\"1\"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] w-full h-full"}></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-neutral-300 mb-8 leading-relaxed">
                Partner with the UAE's leading business setup consultancy. We provide 
                comprehensive corporate services backed by decades of expertise and 
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button size="lg" variant="outline" className="border-neutral-600 text-neutral-300 hover:bg-neutral-800 px-8 py-4 text-lg">
                  Download Brochure
                </Button>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-300 max-w-2xl mx-auto">
              End-to-end corporate services designed to establish and grow your business 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="p-8 bg-neutral-900/50 border-neutral-700 hover:border-brand-600/50 transition-all duration-300">
      ...
      <section id="industries" className="py-20 bg-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-300 max-w-2xl mx-auto">
              Specialized expertise across diverse industry sectors with tailored 
              solutions for each business vertical.
            </p>
          </div>

          <div className="grid md:grid-cols-4 gap-4">
            {industries.map((industry, index) => (
              <Card key={index} className="p-6 bg-neutral-800/50 border-neutral-700 hover:bg-neutral-800 hover:border-brand-600/50 transition-all duration-300 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="p-8 bg-neutral-900/50 border-neutral-700">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-gradient-to-r from-brand-600 to-brand-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Establish Your UAE Presence?
          </h2>
          <p className="text-xl text-brand-100 mb-8 max-w-2xl mx-auto">
            Connect with our senior consultants to discuss your business objectives 
            and explore the optimal setup strategy for your UAE venture.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-brand-600 hover:bg-neutral-100 px-8 py-4 text-lg font-semibold">
              Schedule Executive Meeting
            </Button>
            <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-brand-600 px-8 py-4 text-lg font-semibold">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-neutral-400 mb-6 max-w-md">
                ...
                comprehensive corporate services with unmatched expertise and dedication.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-neutral-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Banking Solutions</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Visa Services</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Legal Advisory</a></li>
              </ul>
            </div>
